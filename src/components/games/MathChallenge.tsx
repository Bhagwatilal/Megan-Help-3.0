...
const MathChallenge: React.FC<GameProps> = () => {
  ...
  const generateQuestion = () => {
    ...
    // Create question and calculate answer
    question = `${num1} ${operator} ${num2}`;
    
    if (operator === "+") {
      answer = num1 + num2;
    } else if (operator === "-") {
      // For easy and medium, ensure the result is positive
      ...
      <CardContent>
        {!isGameActive ? (
          <div className="text-center space-y-6 py-4">
            ...
            <p className="mb-4">Solve math problems as quickly as possible. The game ends when you give a wrong answer or time runs out.</p>
            ...
            {highScore > 0 && (
              <div className="text-sm text-gray-600">
                Your high score: {highScore} points
              </div>
            )}
          </div>
        ) : (
          <div className="space-y-6">
            ...
            <div className="text-center space-y-6 py-4">
              <div className="text-3xl md:text-5xl font-bold my-8">
